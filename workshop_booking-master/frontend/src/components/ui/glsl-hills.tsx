...
const GLSLHills: React.FC<GLSLHillsProps> = ({ width = '100vw', height = '100vh', cameraZ = 125, planeSize = 256, speed = 0.5 }) => {
  ...
  useEffect(() => {
    ...
    class Plane {
      ...
      render(deltaTime: number): void {
        (this.uniforms.time as any).value += deltaTime * this.time;
      }
    }
